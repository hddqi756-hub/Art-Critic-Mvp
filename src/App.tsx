...
const makeTask = (imageUrl: string): ReviewTask => ({
  ...
  artworkBounds: {
    faceRegion: { x: 24, y: 8, width: 26, height: 26 },
    textRegion: { x: 2, y: 2, width: 18, height: 8 },
    colorCardRegion: { x: 82, y: 4, width: 14, height: 18 },
    backgroundWhitespaceRegion: { x: 0, y: 0, width: 100, height: 14 },
  },
  knowledgeCards: [],
  practiceSets: [],
  studentMemory: { recurringIssues: ['明度分组'], learnedConcepts: [], generatedAssets: [], teacherSummary: '先稳住局部，不追求一键变漂亮。' },
  aiMeta: { provider: 'openai', analysisModel: 'gpt-5.5', imageModel: 'gpt-image-2', editModel: 'gpt-image-2', mode: 'mock_fallback', imageApiCalled: false, mock: true },
  logs: [],
